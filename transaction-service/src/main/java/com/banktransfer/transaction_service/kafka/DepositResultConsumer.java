...
import com.banktransfer.transaction_service.event.DepositResultEvent;
...
public class DepositResultConsumer {
    ...
    @KafkaListener(topics = "deposit-result-topic", groupId = "transaction-service-group")
    public void handleDepositResult(DepositResultEvent event) {
