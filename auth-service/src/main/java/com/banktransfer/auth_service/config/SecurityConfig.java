package com.banktransfer.auth_service.config;
...
public class SecurityConfig {
    ...
    private final JwtAuthenticationFilter jwtAuthFilter;   // on le crée juste après
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder();   // hash sécurisé, jamais de mot de passe en clair en base
    }

    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        CorsConfiguration configuration = new CorsConfiguration();
        configuration.setAllowedOrigins(List.of("http://localhost:4200"));   // ton futur frontend Angular
